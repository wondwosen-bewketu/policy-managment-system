...
export class Migration1732275557493 implements MigrationInterface {
  name = 'Migration1732275557493';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "policies" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "vehicleModel" character varying(64) NOT NULL, "vehiclePlateNumber" character varying NOT NULL, "policyNumber" character varying NOT NULL, "coverageAmount" numeric(10,2) NOT NULL, "premiumAmount" numeric(10,2) NOT NULL, "deductibleAmount" numeric(10,2) NOT NULL, "startDate" TIMESTAMP WITH TIME ZONE NOT NULL, "endDate" TIMESTAMP WITH TIME ZONE NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "rejectedAt" TIMESTAMP WITH TIME ZONE, "rejectedReason" character varying(2400), "cancledAt" TIMESTAMP WITH TIME ZONE, "cancledReason" character varying(2400), "paymentFrequency" "public"."policies_paymentfrequency_enum" NOT NULL DEFAULT 'MONTHLY', CONSTRAINT "PK_603e09f183df0108d8695c57e28" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
